...
namespace BuildReportTool.Window.Screen
{
	public class BuildSettings : BaseScreen
	{
		...
		void DrawSetting(string name, string val, bool showEvenIfEmpty = true)
		{
			...
			{
				GUILayout.TextField(val, BuildReportTool.Window.Settings.SETTING_VALUE_STYLE_NAME, BRT_BuildReportWindow.LayoutNone);
			}
		...
		void DrawSetting(string name, string[] val, bool showEvenIfEmpty = true)
		{
			...
			if (val != null)
			{
				...
				{
					GUILayout.TextField(val[n], BuildReportTool.Window.Settings.SETTING_VALUE_STYLE_NAME, BRT_BuildReportWindow.LayoutNone);
				}
